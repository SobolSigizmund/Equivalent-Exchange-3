...
import com.pahimar.ee3.util.helper.ColorHelper;
...
public class RecipeAlchemicalBagDyes implements IRecipe {
    ...
    public ItemStack getCraftingResult(InventoryCrafting inventoryCrafting) {
        ...
        for (k = 0; k < inventoryCrafting.getSizeInventory(); ++k) {
            ...
            if (currentStack != null) {
                if (currentStack.getItem() instanceof ItemAlchemicalBag) {
                    ...
                    if (ItemStackHelper.hasColor(currentStack)) {
                        currentColor = ItemStackHelper.getColor(itemStack);
                    ...
                    float[] dyeColorChannels = ColorHelper.getRGB(EnumDyeColor.byDyeDamage(currentStack.getMetadata()));
        ...
        if (itemAlchemicalBag == null) {
            ...
            ItemStackHelper.setColor(itemStack, newColor);
            return itemStack;
        }
    }
