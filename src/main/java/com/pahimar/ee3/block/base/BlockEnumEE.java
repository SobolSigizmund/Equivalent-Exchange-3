...
public abstract class BlockEnumEE<T extends Enum<T> & BlockEnumEE.IEnumMeta & IStringSerializable> extends BlockEE {

    private final T[] variants;

    public BlockEnumEE(String name, Class<T> clazz) {
        this(name, Material.rock, clazz);
    }

    public BlockEnumEE(String name, Material material, Class<T> clazz) {
        super(name, material);
